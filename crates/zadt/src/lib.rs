...
pub use objects::{
    ...
    AnnotationDefinitionCreatePropertiesBuilderError, AnnotationDefinitionProperties, Class,
    ...
    InvalidWorkbenchType, MetadataExtension, MetadataExtensionCreateProperties,
    MetadataExtensionCreatePropertiesBuilder, MetadataExtensionCreatePropertiesBuilderError,
    MetadataExtensionProperties, ObjectKey, ObjectRef, ObjectReferences, ObjectSnapshot,
    ObjectType, Package, PackageAssignment, PackageAttributes, PackageProperties, PackageTransport,
    PackageUseAccess, PrimaryObjectType, Program, ProgramProperties, Resources, ServiceDefinition,
