...
pub use objects::{
    ...
    FunctionModuleCreatePropertiesBuilderError, FunctionModuleProperties, GlobalWorkbenchType,
    Identity, Include, IncludeProperties, Interface, InterfaceCreateProperties,
    InterfaceCreatePropertiesBuilder, InterfaceCreatePropertiesBuilderError, InterfaceProperties,
    InvalidObjectName, InvalidWorkbenchType, LogicalDatabase, MetadataExtension,
    MetadataExtensionCreateProperties, MetadataExtensionCreatePropertiesBuilder,
    MetadataExtensionCreatePropertiesBuilderError, MetadataExtensionProperties, ObjectKey,
    ObjectName, ObjectRef, ObjectReferences, ObjectSnapshot, ObjectType, Package,
    PackageAssignment, PackageAttributes, PackageProperties, PackageTransport, PackageUseAccess,
