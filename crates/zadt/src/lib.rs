...
pub use objects::{
    ...
    ClassTemplate, ClassTemplateProperty, Create, CreationPropertyModel, DataDefinition,
    ...
    DataElementPropertiesVersion, GlobalWorkbenchType, Include, IncludeProperties,
    IncludePropertyVersion, InvalidWorkbenchType, Object, ObjectRef, ObjectReferences, ObjectType,
