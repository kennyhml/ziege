...
pub use objects::{
    ...
    InvalidObjectName, InvalidWorkbenchType, MetadataExtension, MetadataExtensionCreateProperties,
    ...
    PackageTransport, PackageUseAccess, PrimaryObjectType, Program, ProgramProperties, Resources,
